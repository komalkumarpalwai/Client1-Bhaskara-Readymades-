...
const MEN_CATEGORIES = ['All Men', 'Shirts', 'Trousers', 'Ethnic Wear'];
    ...
    const fetchProducts = async () => {
      try {
        ...
        const menItems = all.filter((p) =>
          ['Shirts', 'Trousers', 'Ethnic Wear'].includes(p.category)
        );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="border-b border-slate-200 pb-4 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <div className="text-xs font-bold font-mono text-amber-700 uppercase tracking-widest flex items-center space-x-1.5">
              ...
              <span>Gentlemen's Collection</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">
              Men's Readymade Wear
            </h1>
            <p className="text-xs text-slate-500 mt-0.5">
              Shirts, Trousers, Ethnic Kurtas & Dhotis directly from our Saripalli showroom.
            </p>
          </div>
        ...
        {loading ? (
          <div className="py-24 text-center space-y-3">
            ...
            <p className="text-xs font-mono uppercase text-slate-500">Loading Men's Garments...</p>
          </div>
